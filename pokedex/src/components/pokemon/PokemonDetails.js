...
export default class PokemonDetails extends Component {
    ...
    async componentDidMount() {
        ...
        const pokemonRes = await pokeapi.get(`pokemon/${pokemonIndex}`);
        ...
        // Convert Decimeters to Meters / 100 is for rounding to two decimal places
        const height =
            Math.round(pokemonRes.data.height / 10) / 100;

        // Convert hectograms to Kg  / 100 is for rounding to two decimal places
        const weight =
